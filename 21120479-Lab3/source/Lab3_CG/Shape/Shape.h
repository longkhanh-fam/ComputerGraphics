...
public:
	...
	{
		rotateFilledPixel(rotationAngle);
		rotateOutline(rotationAngle);
	}
	virtual void rotateFilledPixel(float rotationAngle) {}
	virtual void rotateOutline(float rotationAngle) {}


	//translate
	void translate(double offsetX, double offsetY) {
		translateFilledPixel(offsetX, offsetY);
		translateOutline(offsetX, offsetY);
	}
	virtual void translateFilledPixel(double offsetX, double offsetY) {}
	virtual void translateOutline(double offsetX, double offsetY) {}

	//scale
	void scale(double scaleX, double scaleY) {
		scaleFilledPixel(scaleX, scaleY);
		scaleOutline(scaleX, scaleY);
	}
	virtual void scaleFilledPixel(double scaleX, double scaleY) {}
	virtual void scaleOutline(double scaleX, double scaleY) {}
};
#endif 